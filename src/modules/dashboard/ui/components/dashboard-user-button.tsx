...
export const DashboardUserButton = () => {
        ...
        return (
            ...
            justify-between bg-white/5 hover:bg-white/10 overflow-hidden gap-x-2'>
                ...
                <DrawerContent>
                    ...
                    <DrawerFooter>
                        <Button className='size-4 text-black' variant='outline' onClick={()=> {}}>
                            <CreditCardIcon/>
                            Billing
                        </Button>
                        <Button className='size-4 text-black' variant='outline' onClick={onLogout}>
                            <LogOutIcon/>
                            Logout
                        </Button>
                    </DrawerFooter>
    ...
    return (
        <DropdownMenu>
            ...
            <DropdownMenuContent align='end' side='right' className='72'>
                <DropdownMenuLabel>
